...
import com.popble.repository.ReviewRepository2;
...
public class ReviewService2 {
    ...
    public void saveReview(ReviewRequest2 reviewRequest, List<MultipartFile> imageFiles) throws Exception {
        ...
        // 리뷰 엔티티 기본 정보 생성
        Review2 review = Review2.builder()
        ...
        if (imageFiles != null && !imageFiles.isEmpty()) {
            ...
            List<ReviewImage2> reviewImages = new ArrayList<>();
            ...
            for (int i = 0; i < imageFiles.size(); i++) {
                ...
                // ReviewImage 엔티티 생성
                ReviewImage2 reviewImage = new ReviewImage2();
