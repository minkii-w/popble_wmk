...
import { getList } from "../../../api/BoardApi" // 경로 확인!
...
const QnaList = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        setLoading(true)
        const data = await getList({ type: "QNA", order: "latest" })
  ...
  return (
    <div className="p-6 w-full bg-white">
      <h1 className="text-2xl font-bold mb-4">질문게시판</h1>
